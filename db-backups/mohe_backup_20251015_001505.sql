...
\restrict hNWCx8sjERvzNb3nDMApU0FPyODW3dHR6Jl3G7MmM8Mb98SeTDyAopNoEEM93yC
...
\unrestrict hNWCx8sjERvzNb3nDMApU0FPyODW3dHR6Jl3G7MmM8Mb98SeTDyAopNoEEM93yC
\connect mohe_db
\restrict hNWCx8sjERvzNb3nDMApU0FPyODW3dHR6Jl3G7MmM8Mb98SeTDyAopNoEEM93yC
...
--
-- Name: place_keyword_extractions; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.place_keyword_extractions (
    id bigint NOT NULL,
    created_at timestamp(6) without time zone,
    extraction_method character varying(50),
    keyword_vector public.vector(100) NOT NULL,
...
--
-- Name: place_keyword_extractions_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.place_keyword_extractions_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: place_keyword_extractions_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.place_keyword_extractions_id_seq OWNED BY public.place_keyword_extractions.id;
...
--
-- Name: place_keyword_extractions id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.place_keyword_extractions ALTER COLUMN id SET DEFAULT nextval('public.place_keyword_extractions_id_seq'::regclass);
...
--
-- Data for Name: place_keyword_extractions; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.place_keyword_extractions (id, created_at, extraction_method, keyword_vector, model_name, model_version, place_id, processing_time_ms, raw_text, selected_keywords, updated_at) FROM stdin;
\.
...
--
-- Name: place_keyword_extractions_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.place_keyword_extractions_id_seq', 1, false);
...
--
-- Name: place_keyword_extractions place_keyword_extractions_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.place_keyword_extractions
    ADD CONSTRAINT place_keyword_extractions_pkey PRIMARY KEY (id);
